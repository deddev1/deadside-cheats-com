...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'naraka cheats esp',
		caption: 'naraka cheats esp wallhack player boxes',
	},
	{
		src: '/images/naraka-screenshot-02.webp',
		title: 'naraka cheats wallhack',
		caption: 'naraka cheats wallhack esp through walls',
	},
	{
		src: '/images/naraka-screenshot-03.webp',
		title: 'naraka cheats aimbot',
		caption: 'naraka cheats aimbot soft aim in match',
	},
	{
		src: '/images/naraka-screenshot-04.webp',
		title: 'naraka cheats mod menu',
		caption: 'naraka cheats mod menu with ESP and radar toggles',
	},
	{
		src: '/images/naraka-screenshot-05.webp',
		title: 'naraka cheats radar',
		caption: 'naraka cheats 2d radar hack overlay',
	},
	{
		src: '/images/naraka-screenshot-06.webp',
		title: 'naraka cheats overlay',
		caption: 'naraka cheats esp and aimbot in match',
	},
	{
		src: '/images/naraka-screenshot-07.webp',
		title: 'naraka cheats player esp',
		caption: 'naraka cheats wallhack player outlines',
	},
	{
		src: '/images/naraka-screenshot-08.webp',
		title: 'naraka cheats gameplay',
		caption: 'naraka cheats aimbot and esp ranked gameplay',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Naraka', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'naraka-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'naraka-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	updates: { title: '{primaryKeyword} live status', caption: 'Check {primaryKeyword} after a game or NEAC patch' },
	...
	neac: { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a NEAC update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Naraka on PC' },
