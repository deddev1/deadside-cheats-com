...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'deadside cheats esp',
		caption: 'deadside cheats esp wallhack player boxes',
	},
	{
		src: '/images/deadside-screenshot-02.webp',
		title: 'deadside cheats wallhack',
		caption: 'deadside cheats wallhack esp through walls',
	},
	{
		src: '/images/deadside-screenshot-03.webp',
		title: 'deadside cheats aimbot',
		caption: 'deadside cheats aimbot soft aim in match',
	},
	{
		src: '/images/deadside-screenshot-04.webp',
		title: 'deadside cheats mod menu',
		caption: 'deadside cheats mod menu with ESP and radar toggles',
	},
	{
	...
	},
	{
		...
		title: 'deadside cheats overlay',
		caption: 'deadside cheats esp and aimbot in match',
	},
	{
		src: '/images/deadside-screenshot-07.webp',
		title: 'deadside cheats player esp',
		caption: 'deadside cheats wallhack player outlines',
	},
	{
		src: '/images/deadside-screenshot-08.webp',
		title: 'deadside cheats gameplay',
		caption: 'deadside cheats aimbot and esp ranked gameplay',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Deadside', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'deadside-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'deadside-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Deadside on PC' },
