...
export const pageSitemapMeta: Record<PageId, PageSitemapMeta> = {
	...
	'deadside-esp': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-24' },
	'deadside-aimbot': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-24' },
...
export const SITEMAP_COUNTS = {
	...
	pagesPerLocale: 18,
	i18nUrls: 5 * 18,
	totalIndexablePages: 179 + 5 * 18,
	hreflangLinksPerUrl: 7,
	/** sitemap.xml (index): EN + 5 indexable locale sitemaps + images */
	sitemapIndexEntries: 1 + 5 + 1,
} as const;
