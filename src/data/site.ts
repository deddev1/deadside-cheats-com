...
export const homeFaqs: readonly FaqItem[] = [
	faq({
		...
		seoTitle: 'What is {brand}? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Are {brand} Undetected in 2026? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Raid Session and PvP Support | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'ESP, Wallhack, Radar & Aimbot | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'How Are {brand} Licenses Delivered? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Where to Check {game} / {antiCheat} Updates | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'How to Contact {brand} Support | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'How Much Do {game} Hacks Cost? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'How to Install {game} Hacks on Windows PC | Deadside FAQ',
		seoDescription:
...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		seoTitle: 'What Is a {game} Wallhack? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Does {brand} Include a 2D Radar? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'How {antiCheat} Affects {brand} | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Buy Undetected {game} Hacks for Windows PC | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'What Is a {game} ESP Hack? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'What Is a {game} Aimbot Hack? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Best {game} Hacks in 2026 | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Monthly vs Lifetime {game} Hacks | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Do {game} Hacks Work on Windows 11? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'What Is {game} Soft Aim? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Free {game} Cheat Download? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: '{antiCheat} Bypass for {game} Hacks | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Do {game} Hacks Work in PvP Raids? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'What Is a {game} Mod Menu? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'External vs Internal {game} Hacks | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'How Long Does {game} Cheats Setup Take? | Deadside FAQ',
		seoDescription:
	...
	faq({
		...
		seoTitle: 'Does {brand} Include Triggerbot? | Deadside FAQ',
		seoDescription:
