...
export const customerReviews = [
	reviewMeta({
		...
		rating: 5,
		text: 'ngl i tried like 3 diff naraka cheats before this and they all felt way too snappy in ranked. these naraka cheats actually let you tune smooth aim so it doesnt look obvious on bind/haven. dia lobbies for a week now, setup took probs 12 min after defender whitelisted the loader. no drama yet tbh',
		short: 'tried 3 naraka cheats before — these naraka cheats feel human in dia ranked once you tune smooth aim on bind',
		slug: 'naraka-soft-aim-review-xkrypt0',
		seoTitle: 'Soft Aim Review by @xKrypt0_Naraka — 5/5 | {brand}',
		seoDescription:
			'@xKrypt0_Naraka rates {brand} naraka cheats soft aim 5/5 after testing in diamond ranked on Windows PC.',
		date: '2026-07-24',
		tag: 'Soft aim',
	}),
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'i dont even run aimbot much, the naraka cheats esp is why i bought. seeing who peeked before you swing on ascent is insane info. been on monthly for a few weeks and its worth it. only gripe is menu could look cleaner but as naraka cheats go this package is solid',
		short: 'bought for esp not aimbot — naraka cheats wallhack shows peeks before you swing, huge in ranked on ascent',
		slug: 'naraka-esp-growth-run-review-buildsr4k',
		seoTitle: 'ESP Review by @buildsR4K — 4/5 | {brand}',
		seoDescription:
			'@buildsR4K rates {brand} naraka cheats ESP wallhack 4/5 for ranked info on Windows PC.',
		date: '2026-07-19',
		tag: 'ESP',
	}),
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'last naraka cheat i had got cooked the day after a NEAC update lol. switched to these naraka cheats and loader was back same night they posted the rebuild. running esp + radar on pearl, still clean after 2 weeks. grabbed lifetime cause im done paying monthly for dead naraka cheats',
		short: 'old naraka cheat died on neac patch — these naraka cheats rebuilt same night, still undetected 2 weeks on pearl',
		slug: 'naraka-cloud-dma-review-dma-wizard',
		seoTitle: 'Update Review by @dma_wizard — 5/5 | {brand}',
		seoDescription:
			'@dma_wizard rates {brand} naraka cheats 5/5 after a {antiCheat} update — fast rebuild on Windows PC.',
		date: '2026-06-27',
		tag: 'Updates',
	}),
	reviewMeta({
		...
		rating: 4,
		text: 'im not techy at all bro. naraka cheats menu is simple tho — dropped fov on soft aim, bumped smoothing, stopped the snap. feels more like muscle memory now in unrated and ranked. only 4 stars cause first login support took an hour but they fixed my license key quick',
		...
		seoDescription:
			'@ctrl_player99 rates {brand} naraka cheats soft aim 4/5 after FOV tuning on Windows PC.',
		date: '2026-07-11',
		tag: 'Soft aim',
	}),
	reviewMeta({
		...
		rating: 3,
		text: 'naraka cheats work fine once youre actually in game. windows defender blocked the loader first try and i panicked ngl. emailed support with order id, got a reply in like 2 hours with steps. esp looks clean in customs, havent gone full ranked yet. 3 stars cause setup stress but cheat itself seems ok',
		short: 'defender blocked loader at first but support fixed it in 2hrs — naraka cheats esp looks clean in custom games',
		slug: 'naraka-cheat-setup-review-stormchaser07',
		seoTitle: 'Setup Review by @stormChaser_07 — 3/5 | {brand}',
		seoDescription:
			'@stormChaser_07 rates {brand} naraka cheats setup 3/5 — ESP solid after support helped on Windows PC.',
		date: '2026-06-15',
		tag: 'Setup',
	}),
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'mainly wanted agent esp and util tracking for valo. these naraka cheats show kits and rotates earlier than my brain does lol. unrated with friends is way less chaos when you know whos flanking. way better than random free naraka cheat sites that look sketchy af',
		short: 'agent esp on these naraka cheats catches flanks and util early — way better than sketchy free naraka cheats',
		slug: 'naraka-hero-esp-review-lootgoblinx',
		seoTitle: 'Agent ESP Review by @lootGoblinx — 5/5 | {brand}',
		seoDescription:
			'@lootGoblinx rates {brand} naraka cheats hero ESP 5/5 for util tracking on Windows PC.',
		date: '2026-08-01',
		tag: 'ESP',
	}),
	reviewMeta({
		...
		rating: 4,
		text: 'using naraka cheats since the new act dropped. per gun aim profiles help on site holds — vandal vs sheriff actually feels different which is nice. status page was slow after NEAC update but build was back next morning. solid naraka cheats for long grind sessions in plat',
		short: 'naraka cheats per-weapon aim profiles help site holds in plat — back online next day after neac patch',
		slug: 'naraka-soft-aim-session-review-rankedgrind42',
		seoTitle: 'Ranked Soft Aim by @rankedGrind42 — 4/5 | {brand}',
		seoDescription:
			'@rankedGrind42 rates {brand} naraka cheats soft aim 4/5 for ranked site holds on Windows PC.',
		date: '2026-07-07',
		tag: 'Ranked',
	}),
	reviewMeta({
		...
		rating: 5,
		text: 'everyone talks esp but the 2d radar on these naraka cheats is cracked. caught a flank on lotus twice in one game without staring at wallhack boxes. esp + radar combo feels like legit tier 1 naraka cheats. running low opacity so it doesnt scream cheat in clips',
		short: '2d radar on these naraka cheats caught lotus flanks twice — esp + radar combo feels like real naraka cheats',
		slug: 'naraka-radar-hack-review-vanlifenaraka',
		seoTitle: 'Radar Review by @vanLifeNaraka — 5/5 | {brand}',
		seoDescription:
			'@vanLifeNaraka rates {brand} naraka cheats radar 5/5 for flank detection on lotus and other maps.',
		date: '2026-07-28',
		tag: 'Radar',
	}),
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'naraka patch day is when half the cheat discords go silent lol. naraka cheats team posted on status in like 3 hrs and i was back in ranked queue next morning. old provider left me waiting 4 days with no loader. not perfect but way better naraka cheats support than im used to',
		short: 'patch day usually kills naraka cheats — these naraka cheats were back next morning, old provider took 4 days',
		slug: 'naraka-neac-update-review-patchdaymike',
		seoTitle: 'Status Review by @patchDayMike — 4/5 | {brand}',
		seoDescription:
			'@patchDayMike rates {brand} naraka cheats status updates 4/5 after {antiCheat} patches on Windows PC.',
		date: '2026-06-09',
		tag: 'NEAC updates',
	}),
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'operator/anchor player here. long range soft aim on these naraka cheats with esp callouts is stupid strong if you keep settings lowkey. no bloat loader, simple install on win11. best naraka cheats ive used for op sessions on breeze and haven — just dont crank fov like an idiot',
		short: 'operator main — soft aim + esp on these naraka cheats hits different on breeze/haven if you keep settings subtle',
		slug: 'naraka-melee-soft-aim-review-snipezonly',
		seoTitle: 'Operator Soft Aim by @snipezOnly_ — 5/5 | {brand}',
		seoDescription:
			'@snipezOnly_ rates {brand} naraka cheats operator soft aim 5/5 with ESP on Windows PC.',
		date: '2026-08-01',
		tag: 'Operator',
	}),
