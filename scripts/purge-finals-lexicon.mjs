...
const replacements = [
	['published by Facepunch', 'published by 24 Entertainment'],
	['published by Facepunch', 'published by 24 Entertainment'],
	['When Facepunch ships', 'When 24 Entertainment ships'],
	...
	['monument zones and loot runs', 'arena sectors and grapple routes'],
	['Clear monument zones and loot runs', 'Clear arena sectors and grapple routes'],
	...
	['survival melee combats happen across open terrain', 'Map fights happen across open terrain'],
	['loot run', 'cashout route'],
	['loot runs', 'grapple routes'],
