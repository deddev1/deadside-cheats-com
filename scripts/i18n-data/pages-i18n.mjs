...
export const PAGE_META_HOME = {
	es: { title: 'Naraka Cheats 2026 | ESP, Wallhack y Aimbot', desc: 'Trucos Naraka indetectables para Naraka en PC. ESP wallhack, radar hack y Aimbot con mantenimiento NEAC. Entrega digital instantánea.', h1: 'hacks indetectables para Naraka', intro: 'Paquete undetected para Naraka en Windows PC: ESP wallhack, radar y Aimbot con mantenimiento NEAC tras cada parche.', imageAlt: 'Naraka ESP — etiquetas de jugador hack', gallery: 'Galería Naraka Cheats — ESP, Aimbot y wallhack', cta2: 'Ver funciones', h2a: 'Por qué eligen Naraka Cheats en 2026', h2b: 'ESP wallhack, radar y Aimbot en una licencia', topicA: 'Ideal para leer escuadrones enemigos en BR y unrated matches.', topicB: 'Una licencia en lugar de herramientas separadas.' },
	fr: { title: 'Naraka Cheats 2026 | ESP, Wallhack et Aimbot', desc: 'Triches Naraka indétectables pour Naraka sur PC. ESP wallhack, radar hack et Aimbot avec maintenance NEAC. Livraison numérique instantanée.', h1: 'hacks indétectables pour Naraka', intro: 'Pack undetected pour Naraka sur PC Windows : ESP wallhack, radar et Aimbot avec maintenance NEAC après chaque patch.', imageAlt: 'Naraka ESP — tags joueur hack', gallery: 'Galerie Naraka Cheats — ESP, Aimbot et wallhack', cta2: 'Voir les fonctions', h2a: 'Pourquoi choisir Naraka Cheats en 2026', h2b: 'ESP wallhack, radar et Aimbot en une licence', topicA: 'Parfait pour lire les équipes ennemies en BR et unrated matches.', topicB: 'Une licence au lieu d\'outils séparés.' },
	de: { title: 'Naraka Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Naraka Cheats für Naraka auf PC. ESP Wallhack, Radar Hack und Aimbot mit NEAC-Wartung. Sofortige digitale Lieferung.', h1: 'undetected Hacks für Naraka', intro: 'Undetected Windows PC Paket für Naraka: ESP Wallhack, Radar und Aimbot mit NEAC-Wartung nach jedem Patch.', imageAlt: 'Naraka ESP — Spieler-Tags Hack', gallery: 'Naraka Cheats Galerie — ESP, Aimbot und Wallhack', cta2: 'Features ansehen', h2a: 'Warum Naraka Cheats 2026 führt', h2b: 'ESP Wallhack, Radar und Aimbot in einer Lizenz', topicA: 'Ideal um feindliche Squads in BR und unrated matches zu lesen.', topicB: 'Eine Lizenz statt separater Tools.' },
	pt: { title: 'Naraka Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheats Naraka indetectáveis para Naraka no PC. ESP wallhack, radar hack e Aimbot com manutenção NEAC. Entrega digital instantánea.', h1: 'hacks indetectáveis para Naraka', intro: 'Pacote undetected para Naraka no Windows PC: ESP wallhack, radar e Aimbot com manutenção NEAC após cada patch.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Galeria Naraka Cheats — ESP, Aimbot e wallhack', cta2: 'Ver recursos', h2a: 'Por que escolher Naraka Cheats em 2026', h2b: 'ESP wallhack, radar e Aimbot numa licença', topicA: 'Ideal para ler equipes inimigos em BR e unrated matches.', topicB: 'Uma licença em vez de ferramentas separadas.' },
	it: { title: 'Naraka Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheat Naraka indetectable per Naraka su PC. ESP wallhack, radar hack e Aimbot con manutenzione NEAC. Consegna digitale istantanea.', h1: 'hacks indetectable per Naraka', intro: 'Pacchetto undetected per Naraka su PC Windows: ESP wallhack, radar e Aimbot con manutenzione NEAC dopo ogni patch.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Galleria Naraka Cheats — ESP, Aimbot e wallhack', cta2: 'Vedi funzioni', h2a: 'Perché scegliere Naraka Cheats nel 2026', h2b: 'ESP wallhack, radar e Aimbot in una licenza', topicA: 'Ideale per leggere squadre nemiche in BR e unrated matches.', topicB: 'Una licenza invece di tool separati.' },
	nl: { title: 'Naraka Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected naraka cheats voor Naraka op PC. ESP wallhack, radar hack en Aimbot met NEAC-onderhoud. Directe digitale levering.', h1: 'undetected hacks voor Naraka', intro: 'Undetected Windows PC pakket voor Naraka: ESP wallhack, radar en Aimbot met NEAC-onderhoud na elke patch.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Naraka Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Naraka Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke squads te lezen in BR en unrated matches.', topicB: 'Eén licentie in plaats van losse tools.' },
	pl: { title: 'Naraka Cheats 2026 | ESP, Wallhack i Aimbot', desc: 'Undetected cheaty Naraka dla Naraka na PC. ESP wallhack, radar hack i Aimbot z konserwacją NEAC. Natychmiastowa dostawa cyfrowa.', h1: 'undetected hacki dla Naraka', intro: 'Pakiet undetected dla Naraka na Windows PC: ESP wallhack, radar i Aimbot z konserwacją NEAC po każdym patchu.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Galeria Naraka Cheats — ESP, Aimbot i wallhack', cta2: 'Zobacz funkcje', h2a: 'Dlaczego Naraka Cheats w 2026', h2b: 'ESP wallhack, radar i Aimbot w jednej licencji', topicA: 'Idealny do czytania wrogich squadów w BR i unrated matches.', topicB: 'Jedna licencja zamiast osobnych narzędzi.' },
	ru: { title: 'Naraka Cheats 2026 | ESP, Wallhack и Aimbot', desc: 'Undetected читы Naraka для Naraka на PC. ESP wallhack, radar hack и Aimbot с обслуживанием NEAC. Мгновенная цифровая доставка.', h1: 'undetected хаки для Naraka', intro: 'Undetected пакет для Naraka на Windows PC: ESP wallhack, radar и Aimbot с обслуживанием NEAC после патчей.', imageAlt: 'Naraka ESP — теги игроков hack', gallery: 'Галерея Naraka Cheats — ESP, Aimbot и wallhack', cta2: 'Смотреть функции', h2a: 'Почему выбирают Naraka Cheats в 2026', h2b: 'ESP wallhack, radar и Aimbot в одной лицензии', topicA: 'Идеально для чтения вражеских отрядов в BR и unrated matches.', topicB: 'Одна лицензия вместо отдельных инструментов.' },
	tr: { title: 'Naraka Cheats 2026 | ESP, Wallhack ve Aimbot', desc: 'Naraka için undetected hileler. ESP wallhack, radar hack ve Aimbot — NEAC bakımı. Anında dijital teslimat.', h1: 'Naraka için undetected hackler', intro: 'Naraka Windows PC undetected paketi: ESP wallhack, radar ve Aimbot — NEAC bakımı dahil.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Naraka Cheats galeri — ESP, Aimbot ve wallhack', cta2: 'Özellikleri gör', h2a: '2026\'da neden Naraka Cheats', h2b: 'ESP wallhack, radar ve Aimbot tek lisans', topicA: 'BR ve unrated matches\'da düşman squad okumak için ideal.', topicB: 'Ayrı araçlar yerine tek lisans.' },
	ar: { title: 'Naraka Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش Naraka undetected لـ Naraka على PC. ESP wallhack ورadar hack وAimbot مع صيانة NEAC. تسليم رقمي فوري.', h1: 'اختراقات غير مكتشفة لـ Naraka', intro: 'حزمة undetected لـ Naraka على Windows PC: ESP wallhack ورadar وAimbot مع صيانة NEAC.', imageAlt: 'Naraka ESP player tags hack', gallery: 'معرض Naraka Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا Naraka Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في BR وunrated matches.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	ja: { title: 'Naraka Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'Naraka向けundetectedチート。ESP wallhack、radar hack、Aimbot、NEACメンテナンス。即時デジタル配信。', h1: 'Naraka向けundetectedハック', intro: 'Naraka Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、NEACメンテナンス付き。', imageAlt: 'naraka cheats hero ESP aimbot wallhack', gallery: 'Naraka Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にNaraka Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとunrated matchesで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	ko: { title: 'Naraka Cheats 2026 | ESP, Wallhack, Aimbot', desc: 'Naraka undetected 치트. ESP wallhack, radar hack, Aimbot, NEAC 유지보수. 즉시 디지털 배송.', h1: 'Naraka용 undetected 핵', intro: 'Naraka Windows PC undetected 패키지: ESP wallhack, radar, Aimbot, NEAC 유지보수 포함.', imageAlt: 'naraka cheats hero ESP aimbot wallhack', gallery: 'Naraka Cheats 갤러리 — ESP, Aimbot, wallhack', cta2: '기능 보기', h2a: '2026년 Naraka Cheats를 선택하는 이유', h2b: 'ESP wallhack, radar, Aimbot 단일 라이선스', topicA: 'BR 및 unrated matches에서 적 분대 읽기에 이상적.', topicB: '별도 도구 대신 단일 라이선스.' },
	zh: { title: 'Naraka Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'Naraka undetected作弊。ESP wallhack、radar hack、Aimbot、NEAC维护。即时数字交付。', h1: 'Naraka的undetected外挂', intro: 'Naraka Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含NEAC维护。', imageAlt: 'naraka cheats hero ESP aimbot wallhack', gallery: 'Naraka Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Naraka Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和unrated matches中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	hi: { title: 'Naraka Cheats 2026 | ESP, Wallhack और Aimbot', desc: 'Naraka undetected hacks. ESP wallhack, radar hack, Aimbot, NEAC maintenance. Instant digital delivery.', h1: 'Naraka ke liye undetected hacks', intro: 'Naraka Windows PC undetected पैकेज: ESP wallhack, radar, Aimbot, NEAC maintenance सहित.', imageAlt: 'naraka cheats hero ESP aimbot wallhack', gallery: 'Naraka Cheats gallery — ESP, Aimbot, wallhack', cta2: 'फ़ीचर्स देखें', h2a: '2026 में Naraka Cheats क्यों', h2b: 'ESP wallhack, radar, Aimbot एक लाइसेंस में', topicA: 'BR और unrated matches में दुश्मन squad पढ़ने के लिए आदर्श.', topicB: 'अलग टूल्स के बजाय एक लाइसेंस.' },
	id: { title: 'Naraka Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Naraka undetected untuk Naraka di PC. ESP wallhack, radar hack, Aimbot, pemeliharaan NEAC. Pengiriman digital instan.', h1: 'hack undetected untuk Naraka', intro: 'Paket undetected Naraka di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan NEAC.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Galeri Naraka Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Naraka Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca squad musuh di BR dan unrated matches.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	th: { title: 'Naraka Cheats 2026 | ESP, Wallhack และ Aimbot', desc: 'Cheat Naraka undetected สำหรับ Naraka บน PC. ESP wallhack, radar hack, Aimbot, NEAC maintenance. จัดส่งดิจิทัลทันที.', h1: 'hack undetected สำหรับ Naraka', intro: 'แพ็ก undetected สำหรับ Naraka บน Windows PC: ESP wallhack, radar, Aimbot พร้อม NEAC maintenance', imageAlt: 'Naraka ESP player tags hack', gallery: 'แกลเลอรี Naraka Cheats — ESP, Aimbot, wallhack', cta2: 'ดูฟีเจอร์', h2a: 'ทำไมเลือก Naraka Cheats ปี 2026', h2b: 'ESP wallhack, radar, Aimbot ในใบอนุญาตเดียว', topicA: 'เหมาะสำหรับอ่าน squad ศัตรูใน BR และ unrated matches', topicB: 'ใบอนุญาตเดียวแทนเครื่องมือแยก' },
	vi: { title: 'Naraka Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Naraka undetected cho Naraka trên PC. ESP wallhack, radar hack, Aimbot, bảo trì NEAC. Giao hàng kỹ thuật số tức thì.', h1: 'hack undetected cho Naraka', intro: 'Gói undetected Naraka trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì NEAC.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Thư viện Naraka Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Naraka Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc squad địch trong BR và unrated matches.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
	uk: { title: 'Naraka Cheats 2026 | ESP, Wallhack і Aimbot', desc: 'Undetected чіти Naraka для Naraka на PC. ESP wallhack, radar hack, Aimbot, обслуговування NEAC. Мгновенная цифровая доставка.', h1: 'undetected хаки для Naraka', intro: 'Undetected пакет для Naraka на Windows PC: ESP wallhack, radar, Aimbot з обслуговуванням NEAC.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Галерея Naraka Cheats — ESP, Aimbot, wallhack', cta2: 'Дивитися функції', h2a: 'Чому Naraka Cheats у 2026', h2b: 'ESP wallhack, radar і Aimbot в одній ліцензії', topicA: 'Ідеально для читання ворожих загонів у BR і unrated matches.', topicB: 'Одна ліцензія замість окремих інструментів.' },
	cs: { title: 'Naraka Cheats 2026 | ESP, Wallhack a Aimbot', desc: 'Undetected naraka cheaty pro Naraka na PC. ESP wallhack, radar hack, Aimbot, údržba NEAC. Okamžité digitální doručení.', h1: 'undetected hacky pro Naraka', intro: 'Undetected balíček pro Naraka na Windows PC: ESP wallhack, radar, Aimbot s údržbou NEAC.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Galerie Naraka Cheats — ESP, Aimbot, wallhack', cta2: 'Zobrazit funkce', h2a: 'Proč Naraka Cheats v roce 2026', h2b: 'ESP wallhack, radar a Aimbot v jedné licenci', topicA: 'Ideální pro čtení nepřátelských squadů v BR a unrated matches.', topicB: 'Jedna licence místo samostatných nástrojů.' },
	ro: { title: 'Naraka Cheats 2026 | ESP, Wallhack și Aimbot', desc: 'Cheats Naraka undetected pentru Naraka pe PC. ESP wallhack, radar hack, Aimbot, mentenanță NEAC. Livrare digitală instantă.', h1: 'hack-uri undetected pentru Naraka', intro: 'Pachet undetected Naraka pe Windows PC: ESP wallhack, radar, Aimbot cu mentenanță NEAC.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Galerie Naraka Cheats — ESP, Aimbot, wallhack', cta2: 'Vezi funcții', h2a: 'De ce Naraka Cheats în 2026', h2b: 'ESP wallhack, radar și Aimbot într-o licență', topicA: 'Ideal pentru citirea squad-urilor inamice în BR și unrated matches.', topicB: 'O licență în loc de instrumente separate.' },
	sv: { title: 'Naraka Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected naraka cheats för Naraka på PC. ESP wallhack, radar hack, Aimbot, NEAC-underhåll. Omedelbar digital leverans.', h1: 'undetected hacks för Naraka', intro: 'Undetected paket för Naraka på Windows PC: ESP wallhack, radar, Aimbot med NEAC-underhåll.', imageAlt: 'Naraka ESP player tags hack', gallery: 'Naraka Cheats galleri — ESP, Aimbot, wallhack', cta2: 'Se funktioner', h2a: 'Varför Naraka Cheats 2026', h2b: 'ESP wallhack, radar och Aimbot i en licens', topicA: 'Ideal för att läsa fiendesquads i BR och unrated matches.', topicB: 'En licens istället för separata verktyg.' },
};
...
const PAGE_META_TAILS = {
	...
	updates: { suffix: 'NEAC Maintenance Log', focus: 'NEAC patch status and rebuild notes', altKeyword: 'updates NEAC maintenance' },
	...
	eac: { suffix: 'Patch Maintenance', focus: 'how NEAC updates are handled for Naraka cheats', altKeyword: 'NEAC bypass ESP aimbot' },
...
export const TOPIC_NAMES = {
	...
	eac: { en: 'NEAC Bypass', es: 'Bypass NEAC', fr: 'Bypass NEAC', de: 'NEAC Bypass', pt: 'Bypass NEAC', it: 'Bypass NEAC', nl: 'NEAC Bypass', pl: 'Bypass NEAC', ru: 'Bypass NEAC', tr: 'NEAC bypass', ar: 'Bypass NEAC', ja: 'NEAC Bypass', ko: 'NEAC Bypass', zh: 'NEAC Bypass', hi: 'NEAC Bypass', id: 'Bypass NEAC', th: 'NEAC Bypass', vi: 'Bypass NEAC', uk: 'Bypass NEAC', cs: 'NEAC Bypass', ro: 'Bypass NEAC', sv: 'NEAC Bypass' },
	'cheats-2026': { en: 'Naraka Cheats 2026', es: 'Trucos Naraka 2026', fr: 'Triches Naraka 2026', de: 'Naraka Cheats 2026', pt: 'Cheats Naraka 2026', it: 'Cheat Naraka 2026', nl: 'Naraka Cheats 2026', pl: 'Cheaty Naraka 2026', ru: 'Читы Naraka 2026', tr: 'Naraka Hileleri 2026', ar: 'غش Naraka 2026', ja: 'Naraka Cheats 2026', ko: 'Naraka Cheats 2026', zh: 'Naraka作弊 2026', hi: 'Naraka Cheats 2026', id: 'Cheat Naraka 2026', th: 'Naraka Cheats 2026', vi: 'Cheat Naraka 2026', uk: 'Чіти Naraka 2026', cs: 'naraka cheaty 2026', ro: 'Cheats Naraka 2026', sv: 'Naraka Cheats 2026' },
