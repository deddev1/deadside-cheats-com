...
export const PAGE_META_HOME = {
	...
	de: { title: 'Naraka Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Naraka Cheats für Naraka auf PC. ESP Wallhack, Radar Hack und Aimbot mit NEAC-Wartung. Sofortige digitale Lieferung.', h1: 'undetected Cheats für Naraka', intro: 'Undetected Windows PC Paket für Naraka: ESP Wallhack, Radar und Aimbot mit NEAC-Wartung nach jedem Patch.', imageAlt: 'Naraka ESP — Spieler-Tags Hack', gallery: 'Naraka Cheats Galerie — ESP, Aimbot und Wallhack', cta2: 'Features ansehen', h2a: 'Warum Naraka Cheats 2026 führt', h2b: 'ESP Wallhack, Radar und Aimbot in einer Lizenz', topicA: 'Ideal um feindliche Squads in BR und Quick Match sessions zu lesen.', topicB: 'Eine Lizenz statt separater Tools.' },
	...
	ja: { title: 'Naraka Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'Naraka向けundetectedチート。ESP wallhack、radar hack、Aimbot、NEACメンテナンス。即時デジタル配信。', h1: 'Naraka向けundetectedチート', intro: 'Naraka Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、NEACメンテナンス付き。', imageAlt: 'naraka cheats hero ESP aimbot wallhack', gallery: 'Naraka Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にNaraka Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとQuick Match sessionsで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	...
	hi: { title: 'Naraka Cheats 2026 | ESP, Wallhack और Aimbot', desc: 'Naraka undetected hacks. ESP wallhack, radar hack, Aimbot, NEAC maintenance. Instant digital delivery.', h1: 'Naraka ke liye undetected cheats', intro: 'Naraka Windows PC undetected पैकेज: ESP wallhack, radar, Aimbot, NEAC maintenance सहित.', imageAlt: 'naraka cheats hero ESP aimbot wallhack', gallery: 'Naraka Cheats gallery — ESP, Aimbot, wallhack', cta2: 'फ़ीचर्स देखें', h2a: '2026 में Naraka Cheats क्यों', h2b: 'ESP wallhack, radar, Aimbot एक लाइसेंस में', topicA: 'BR और Quick Match sessions में दुश्मन squad पढ़ने के लिए आदर्श.', topicB: 'अलग टूल्स के बजाय एक लाइसेंस.' },
