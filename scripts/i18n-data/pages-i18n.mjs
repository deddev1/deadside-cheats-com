...
export const PAGE_META_HOME = {
	...
	nl: { title: 'Deadside Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected deadside cheats voor Deadside op PC. ESP wallhack, 2D radar en Aimbot met BattlEye-onderhoud. Directe digitale levering.', h1: 'undetected cheats voor Deadside', intro: 'Undetected Windows PC pakket voor Deadside: ESP wallhack, radar en Aimbot met BattlEye-onderhoud na elke patch.', imageAlt: 'Deadside ESP player ESP tags', gallery: 'Deadside Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Deadside Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke squads te lezen in BR en Quick Match sessions.', topicB: 'Eén licentie in plaats van losse tools.' },
	...
	zh: { title: 'Deadside Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'Deadside undetected作弊。ESP wallhack、2D radar、Aimbot、BattlEye维护。即时数字交付。', h1: 'Deadside的undetected外挂', intro: 'Deadside Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含BattlEye维护。', imageAlt: 'deadside cheats player ESP aimbot wallhack', gallery: 'Deadside Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Deadside Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和Quick Match sessions中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	...
	id: { title: 'Deadside Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Deadside undetected untuk Deadside di PC. ESP wallhack, 2D radar, Aimbot, pemeliharaan BattlEye. Pengiriman digital instan.', h1: 'cheat undetected untuk Deadside', intro: 'Paket undetected Deadside di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan BattlEye.', imageAlt: 'Deadside ESP player ESP tags', gallery: 'Galeri Deadside Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Deadside Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca squad musuh di BR dan Quick Match sessions.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	...
	vi: { title: 'Deadside Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Deadside undetected cho Deadside trên PC. ESP wallhack, 2D radar, Aimbot, bảo trì BattlEye. Giao hàng kỹ thuật số tức thì.', h1: 'cheat undetected cho Deadside', intro: 'Gói undetected Deadside trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì BattlEye.', imageAlt: 'Deadside ESP player ESP tags', gallery: 'Thư viện Deadside Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Deadside Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc squad địch trong BR và Quick Match sessions.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
