...
const HOME_CONNECTORS = {
	es: {
		...
		aboutPillar: 'pilar de trucos de Deadside',
	...
	fr: {
		...
		aboutPillar: 'pilier Deadside Cheats',
		aboutEsp: 'guide ESP',
	...
	de: {
		...
		aboutPillar: 'Deadside Cheats Leitfaden',
		aboutEsp: 'ESP-Guide',
	...
	ru: {
		...
		aboutPillar: 'путеводителя Deadside Cheats',
		aboutEsp: 'гайда ESP',
