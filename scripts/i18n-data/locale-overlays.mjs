...
const HOME_CONNECTORS = {
	es: {
		...
		aboutPillar: 'pilar de trucos de Naraka',
	...
	fr: {
		...
		aboutPillar: 'pilier Naraka Cheats',
		aboutEsp: 'guide ESP',
	...
	de: {
		...
		aboutPillar: 'Naraka Cheats Leitfaden',
		aboutEsp: 'ESP-Guide',
	...
	pt: {
		...
		aboutPillar: 'pilar Naraka Cheats',
		aboutEsp: 'guia ESP',
		aboutAimbot: 'controles de aimbot',
	...
	it: {
		...
		aboutPillar: 'pilastro Naraka Cheats',
		aboutEsp: 'guida ESP',
	...
	nl: {
		...
		aboutPillar: 'Naraka Cheats-pijler',
		aboutEsp: 'ESP-gids',
	...
	pl: {
		...
		aboutPillar: 'filaru Naraka Cheats',
	...
	ru: {
		...
		aboutPillar: 'путеводителя Naraka Cheats',
		aboutEsp: 'гайда ESP',
	...
	tr: {
		...
		aboutP2Before: 'Önce',
		aboutPillar: 'Naraka Cheats rehberi',
	...
	ar: {
		...
		aboutPillar: 'دليل Naraka Cheats',
		aboutEsp: 'دليل ESP',
	...
	hi: {
		...
		aboutPillar: 'Naraka Cheats गाइड',
		aboutEsp: 'ESP गाइड',
	...
	th: {
		...
		aboutPillar: 'คู่มือ Naraka Cheats',
		aboutEsp: 'คู่มือ ESP',
	...
	vi: {
		...
		aboutPillar: 'trụ cột Naraka Cheats',
	...
	uk: {
		...
		aboutPillar: 'путівника Naraka Cheats',
		aboutEsp: 'гайду ESP',
	...
	cs: {
		...
		aboutPillar: 'průvodcem Naraka Cheats',
	...
	ro: {
		...
		aboutPillar: 'ghidul Naraka Cheats',
		aboutEsp: 'ghidul ESP',
	...
	sv: {
		...
		aboutPillar: 'Naraka Cheats-guiden',
		aboutEsp: 'ESP-guiden',
...
function buildHomeSeo(ui, locale) {
	...
	const labels = {
		es: {
			...
			linkPlans: 'Planes', linkReviews: n.reviews ?? 'Reseñas', linkFinalsCheats: 'Trucos de Naraka',
		...
		fr: {
			...
			linkPlans: 'Formules', linkReviews: 'Avis', linkFinalsCheats: 'Triches Naraka',
		...
		de: {
			...
			linkPlans: 'Pläne', linkReviews: 'Bewertungen', linkFinalsCheats: 'Naraka Cheats',
...
function buildExternalResources(locale) {
	const labels = {
		es: {
			...
			steam: 'Naraka en PC', steamNote: 'Página oficial de la tienda, requisitos y reseñas.',
			patch: 'Parches y noticias de Naraka', patchNote: 'Lee actualizaciones oficiales antes de cambiar tu loadout.',
			official: 'Sitio oficial de Naraka', officialNote: 'Resumen del juego de 24 Entertainment.',
			wiki: 'Wiki de Naraka (Fandom)', wikiNote: 'Estadísticas, mapas y mecánicas de supervivencia.',
			community: 'Hub de Naraka community', communityNote: 'Anuncios y debates de la comunidad.',
		},
		fr: {
			...
			steam: 'Naraka sur PC', steamNote: 'Page officielle, configuration requise et avis.',
			patch: 'Notes de patch Naraka', patchNote: 'Lisez les mises à jour officielles avant de changer votre loadout.',
			official: 'Site officiel Naraka', officialNote: 'Présentation du jeu par 24 Entertainment.',
			wiki: 'Wiki Naraka (Fandom)', wikiNote: 'Stats joueurs, cartes et mécaniques de survie.',
			community: 'Hub Naraka community', communityNote: 'Annonces et discussions communautaires.',
		},
		de: {
			...
			steam: 'Naraka auf PC', steamNote: 'Offizielle Store-Seite, Systemanforderungen und Bewertungen.',
			patch: 'Patchnotes Naraka', patchNote: 'Offizielle Updates lesen, bevor du dein Loadout änderst.',
			official: 'Offizielle Naraka-Website', officialNote: 'Spielübersicht von 24 Entertainment.',
			wiki: 'Naraka Wiki (Fandom)', wikiNote: 'Spielerstatistiken, Karten und Survival-Mechaniken.',
			community: 'Naraka community Hub', communityNote: 'Ankündigungen und Community-Diskussionen.',
		},
	};
...
export function buildLocaleOverlay(locale, ui) {
	...
	return {
		...
		hero: {
			...
			imageAlt: '{{brand}} — Naraka ESP and aimbot overlay',
