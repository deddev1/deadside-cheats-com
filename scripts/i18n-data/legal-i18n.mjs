...
export const LEGAL_I18N = {
	es: {
		...
		introTopic: 'para narakacheats.org y licencias de Naraka.',
		descFor: 'para Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Información que recopilamos', 'Cómo usamos los datos', 'Tus derechos'],
			sec1p2: 'Los datos de pago se procesan en el checkout de Zadeyo — no se almacenan en narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Usar cheats puede violar los términos del equipo de Naraka — asumes todo riesgo de ban.',
		},
	...
	fr: {
		...
		introTopic: 'pour narakacheats.org et les licences Naraka.',
		descFor: 'pour Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informations collectées', 'Utilisation des données', 'Vos droits'],
			sec1p2: 'Les détails de paiement sont traités par le checkout Zadeyo — non stockés sur narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Utiliser des cheats peut enfreindre les conditions de l\'équipe Naraka — vous assumez tout risque de bannissement.',
		},
	...
	de: {
		...
		introTopic: 'für narakacheats.org und Naraka-Lizenzen.',
		descFor: 'für Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Erhobene Daten', 'Datennutzung', 'Ihre Rechte'],
			sec1p2: 'Zahlungsdaten werden über Zadeyo-Checkout verarbeitet — nicht auf narakacheats.org gespeichert.',
		...
		terms: {
			...
			sec2p2: 'Cheats können gegen die Nutzungsbedingungen des Naraka Teams verstoßen — Sie tragen das volle Ban-Risiko.',
		},
	...
	pt: {
		...
		introTopic: 'para narakacheats.org e licenças Naraka.',
		descFor: 'para Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informações que coletamos', 'Como usamos os dados', 'Seus direitos'],
			sec1p2: 'Detalhes de pagamento são processados pelo checkout Zadeyo — não armazenados em narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Usar cheats pode violar os termos da equipe Naraka — você assume todo risco de ban.',
		},
	...
	it: {
		...
		introTopic: 'per narakacheats.org e licenze Naraka.',
		descFor: 'per Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informazioni raccolte', 'Uso dei dati', 'I tuoi diritti'],
			sec1p2: 'I dati di pagamento sono elaborati dal checkout Zadeyo — non memorizzati su narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Usare cheat può violare i termini del team Naraka — assumi tutto il rischio di ban.',
		},
	...
	nl: {
		...
		introTopic: 'voor narakacheats.org en Naraka-licenties.',
		descFor: 'voor Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informatie die we verzamelen', 'Hoe we gegevens gebruiken', 'Uw rechten'],
			sec1p2: 'Betalingsgegevens worden verwerkt via Zadeyo checkout — niet opgeslagen op narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Cheats gebruiken kan in strijd zijn met de voorwaarden van het 24 Entertainment — u neemt alle ban-risico\'s op u.',
		},
	...
	pl: {
		...
		introTopic: 'dla narakacheats.org i licencji Naraka.',
		descFor: 'dla Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informacje, które zbieramy', 'Jak wykorzystujemy dane', 'Twoje prawa'],
			sec1p2: 'Dane płatności są przetwarzane przez checkout Zadeyo — nie przechowywane na narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Korzystanie z cheatów może naruszać warunki zespołu Naraka — bierzesz na siebie ryzyko bana.',
		},
	...
	ru: {
		...
		introTopic: 'для narakacheats.org и лицензий Naraka.',
		descFor: 'для Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Информация, которую мы собираем', 'Как мы используем данные', 'Ваши права'],
			sec1p2: 'Платёжные данные обрабатываются через checkout Zadeyo — не хранятся на narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Использование читов может нарушать условия команды Naraka — вы принимаете на себя риск бана.',
		},
	...
	tr: {
		...
		introTopic: 'narakacheats.org ve Naraka lisansları için.',
		descFor: 'Naraka Cheats — ESP wallhack, Aimbot için',
		privacy: {
			h2: ['Topladığımız bilgiler', 'Verileri nasıl kullanıyoruz', 'Haklarınız'],
			sec1p2: 'Ödeme bilgileri Zadeyo checkout ile işlenir — narakacheats.org\'da saklanmaz.',
		...
		terms: {
			...
			sec2p2: 'Hile kullanmak Naraka ekibi şartlarını ihlal edebilir — tüm ban riskini üstlenirsiniz.',
		},
	...
	ar: {
		...
		introTopic: 'لـ narakacheats.org وتراخيص Naraka.',
		descFor: 'لـ Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['المعلومات التي نجمعها', 'كيف نستخدم البيانات', 'حقوقك'],
			sec1p2: 'تُعالَج تفاصيل الدفع عبر checkout Zadeyo — ولا تُخزَّن على narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'استخدام الغش قد ينتهك شروط فريق Naraka — أنت تتحمل كل مخاطر الحظر.',
		},
	...
	ja: {
		...
		introTopic: 'narakacheats.orgおよびNarakaライセンス向け。',
		descFor: 'Naraka Cheats — ESP wallhack、Aimbot向け',
		privacy: {
			h2: ['収集する情報', 'データの利用方法', 'あなたの権利'],
			sec1p2: '支払い情報はZadeyo checkoutで処理され、narakacheats.orgには保存されません。',
		...
		terms: {
			...
			sec2p2: 'チートの使用はNarakaチームの利用規約に違反する可能性があり、BANリスクはすべて自己負担です。',
		},
	...
	ko: {
		...
		readTerms: '이용 약관 읽기',
		readPrivacy: '개인정보 읽기',
		introTopic: 'narakacheats.org 및 Naraka 라이선스용.',
		descFor: 'Naraka Cheats — ESP wallhack, Aimbot용',
		privacy: {
			h2: ['수집하는 정보', '데이터 사용 방법', '귀하의 권리'],
			sec1p2: '결제 정보는 Zadeyo checkout에서 처리되며 narakacheats.org에 저장되지 않습니다.',
		...
		terms: {
			...
			sec2p2: '치트 사용은 Naraka 팀 약관 위반일 수 있으며 모든 밴 위험은 본인 부담입니다.',
		},
	...
	zh: {
		...
		readTerms: '阅读使用条款',
		readPrivacy: '阅读隐私政策',
		introTopic: '适用于 narakacheats.org 和 Naraka 许可证。',
		descFor: 'Naraka Cheats — ESP wallhack、Aimbot',
		privacy: {
			h2: ['我们收集的信息', '数据使用方式', '您的权利'],
			sec1p2: '支付详情由 Zadeyo checkout 处理 — 不存储在 narakacheats.org。',
		...
		terms: {
			h2: ['接受条款', '风险免责声明', '政策变更'],
			sec2p2: '使用作弊可能违反 Naraka 团队条款 — 您承担所有封禁风险。',
		},
	...
	hi: {
		...
		introTopic: 'narakacheats.org और Naraka लाइसेंस के लिए।',
		descFor: 'Naraka Cheats — ESP wallhack, Aimbot के लिए',
		privacy: {
			h2: ['हम जो जानकारी एकत्र करते हैं', 'हम डेटा का उपयोग कैसे करते हैं', 'आपके अधिकार'],
			sec1p2: 'भुगतान विवरण Zadeyo checkout द्वारा संसाधित — narakacheats.org पर संग्रहीत नहीं।',
		...
		terms: {
			...
			sec2p2: 'cheat का उपयोग Naraka टीम की शर्तों का उल्लंघन हो सकता है — आप सभी ban जोखिम स्वीकार करते हैं।',
		},
	...
	id: {
		...
		introTopic: 'untuk narakacheats.org dan lisensi Naraka.',
		descFor: 'untuk Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informasi yang kami kumpulkan', 'Cara kami menggunakan data', 'Hak Anda'],
			sec1p2: 'Detail pembayaran diproses oleh checkout Zadeyo — tidak disimpan di narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Menggunakan cheat dapat melanggar ketentuan tim Naraka — Anda menanggung semua risiko ban.',
		},
	...
	th: {
		...
		introTopic: 'สำหรับ narakacheats.org และใบอนุญาต Naraka',
		descFor: 'สำหรับ Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['ข้อมูลที่เราเก็บ', 'การใช้ข้อมูล', 'สิทธิของคุณ'],
			sec1p2: 'รายละเอียดการชำระเงินประมวลผลผ่าน checkout Zadeyo — ไม่เก็บบน narakacheats.org',
		...
		terms: {
			...
			sec2p2: 'การใช้ cheat อาจละเมิดข้อกำหนดของทีม Naraka — คุณรับความเสี่ยง ban ทั้งหมด',
		},
	...
	vi: {
		...
		introTopic: 'cho narakacheats.org và giấy phép Naraka.',
		descFor: 'cho Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Thông tin chúng tôi thu thập', 'Cách chúng tôi sử dụng dữ liệu', 'Quyền của bạn'],
			sec1p2: 'Chi tiết thanh toán được xử lý qua checkout Zadeyo — không lưu trên narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Dùng cheat có thể vi phạm điều khoản của đội Naraka — bạn chịu mọi rủi ro ban.',
		},
	...
	uk: {
		...
		introTopic: 'для narakacheats.org та ліцензій Naraka.',
		descFor: 'для Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Інформація, яку ми збираємо', 'Як ми використовуємо дані', 'Ваші права'],
			sec1p2: 'Платіжні дані обробляються через checkout Zadeyo — не зберігаються на narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Використання читів може порушувати умови команди Naraka — ви приймаєте на себе ризик бану.',
		},
	...
	cs: {
		...
		introTopic: 'pro narakacheats.org a licence Naraka.',
		descFor: 'pro Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informace, které shromažďujeme', 'Jak používáme data', 'Vaše práva'],
			sec1p2: 'Platební údaje zpracovává checkout Zadeyo — neukládají se na narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Používání cheatů může porušovat podmínky týmu Naraka — nesete veškeré riziko bana.',
		},
	...
	ro: {
		...
		introTopic: 'pentru narakacheats.org și licențe Naraka.',
		descFor: 'pentru Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Informații pe care le colectăm', 'Cum folosim datele', 'Drepturile tale'],
			sec1p2: 'Detaliile de plată sunt procesate prin checkout Zadeyo — nu sunt stocate pe narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Folosirea cheat-urilor poate încălca termenii echipei Naraka — îți asumi tot riscul de ban.',
		},
	...
	sv: {
		...
		introTopic: 'för narakacheats.org och Naraka-licenser.',
		descFor: 'för Naraka Cheats — ESP wallhack, Aimbot',
		privacy: {
			h2: ['Information vi samlar in', 'Hur vi använder data', 'Dina rättigheter'],
			sec1p2: 'Betalningsuppgifter behandlas via Zadeyo checkout — lagras inte på narakacheats.org.',
		...
		terms: {
			...
			sec2p2: 'Att använda cheats kan bryta mot 24 Entertainment terms — du tar all ban-risk.',
		},
