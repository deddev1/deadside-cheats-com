...
export const FAQ_I18N = {
	es: {
		'what-are-deadside-cheats': {
			q: '¿Qué es Deadside Cheats?',
			a: 'Deadside Cheats es un paquete de trucos indetectables para Deadside en PC Windows. Incluye ESP wallhack, radar 2D y controles de aimbot, con mantenimiento BattlEye y soporte de instalación.',
		},
		'are-deadside-cheats-undetected-in-2026': {
			q: '¿Los trucos de Deadside son indetectables en 2026?',
		...
		'esp-wallhack-radar-or-aimbot': {
			...
			a: 'Deadside Cheats agrupa ESP wallhack, marcadores de loot, radar 2D y Aimbot configurable en una licencia. Consulta Funciones para la lista completa.',
		},
		...
		'where-to-check-updates': {
			q: '¿Dónde reviso actualizaciones tras un parche de Deadside o BattlEye?',
		...
		'battleye-anti-cheat-and-deadside-cheats': {
			q: '¿Cómo afecta BattlEye a los trucos de Deadside?',
			a: 'BattlEye monitoriza Deadside en PC Windows. Deadside Cheats publica notas de mantenimiento tras parches que pueden requerir una nueva build. Revisa Estado antes de jugar.',
		},
		'buy-undetected-deadside-cheats-windows-pc': {
			q: '¿Puedo comprar trucos indetectables de Deadside para PC Windows?',
			a: 'Sí: Deadside Cheats vende licencias mensuales y de por vida para PC Windows con ESP, radar y aimbot en un solo paquete. Compara planes en la Tienda antes del checkout.',
		},
	},
	fr: {
		'what-are-deadside-cheats': {
			q: "Qu'est-ce que Deadside Cheats ?",
			a: "Deadside Cheats est un squad de triches indétectables pour Deadside sur PC Windows. Il inclut ESP wallhack, radar 2D et contrôles aimbot, avec maintenance BattlEye et aide à l'installation.",
		},
		'are-deadside-cheats-undetected-in-2026': {
			q: 'Les triches Deadside sont-elles indétectables en 2026 ?',
		...
		'esp-wallhack-radar-or-aimbot': {
			...
			a: "Deadside Cheats regroupe ESP wallhack, marqueurs de loot, radar 2D et Aimbot configurable dans une licence. Voir Fonctions pour la liste complète.",
		},
		'how-are-licenses-delivered': {
		...
		'where-to-check-updates': {
			q: 'Où vérifier les mises à jour après un patch Deadside ou BattlEye ?',
		...
		'battleye-anti-cheat-and-deadside-cheats': {
			q: 'Comment BattlEye affecte-t-il les triches Deadside ?',
			a: "BattlEye surveille Deadside sur PC Windows. Deadside Cheats publie des notes de maintenance après les patchs. Consultez Statut avant de jouer.",
		},
		'buy-undetected-deadside-cheats-windows-pc': {
			q: 'Puis-je acheter des triches Deadside indétectables pour PC Windows ?',
			a: "Oui — Deadside Cheats vend des licences mensuelles et à vie pour PC Windows avec ESP, radar et aimbot. Comparez les formules sur la page Tarifs.",
		},
	},
	de: {
		'what-are-deadside-cheats': {
			q: 'Was ist Deadside Cheats?',
			a: 'Deadside Cheats ist ein undetected Paket für Deadside auf Windows PC. Es enthält ESP Wallhack, 2D-Radar und Aimbot-Steuerung mit BattlEye-Wartung und Setup-Support.',
		},
		'are-deadside-cheats-undetected-in-2026': {
			q: 'Sind Deadside Cheats 2026 undetected?',
		...
		'esp-wallhack-radar-or-aimbot': {
			...
			a: 'Deadside Cheats bündelt ESP Wallhack, Loot-Marker, 2D-Radar und konfigurierbaren Aimbot in einer Lizenz. Siehe Features für die vollständige Liste.',
		},
		'how-are-licenses-delivered': {
		...
		'where-to-check-updates': {
			q: 'Wo prüfe ich Updates nach einem Deadside- oder BattlEye-Patch?',
		...
		'battleye-anti-cheat-and-deadside-cheats': {
			q: 'Wie wirkt sich BattlEye auf Deadside Cheats aus?',
			a: 'BattlEye überwacht Deadside auf Windows PC. Deadside Cheats veröffentlicht Wartungshinweise nach Patches. Prüfe Status vor dem Spielen.',
		},
		'buy-undetected-deadside-cheats-windows-pc': {
			q: 'Kann ich undetected Deadside Cheats für Windows PC kaufen?',
			a: 'Ja — Deadside Cheats verkauft Monats- und Lifetime-Lizenzen für Windows PC mit ESP, Radar und Aimbot. Vergleiche Pläne auf der Preisseite.',
		},
	},
};
	...
	for (const [slug, entry] of Object.entries(base)) {
		items[slug] = {
			q: entry.q
				...
				.replace(/trucos de Deadside/g, 'Deadside Cheats')
...
/** Apply Deadside-accurate FAQ copy over legacy Valorant terminology. */
