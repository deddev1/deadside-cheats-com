...
export const phrases = {
	...
	pt: {
		...
		legal: () => 'Contacte support@deadsidecheats.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Deadside Cheats', undetected: 'indetectable', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'Contatta support@deadsidecheats.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Deadside Cheats kopen', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
	...
	ru: {
		...
		legal: () => 'support@deadsidecheats.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Deadside Cheats satın al', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'Destek ve yasal sorular için support@deadsidecheats.com.',
	},
	ar: {
		buy: 'اشترِ Deadside Cheats', undetected: 'غير مكتشف', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Deadside Cheatsを購入', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'サポート・法務: support@deadsidecheats.com',
	},
	ko: {
		buy: 'Deadside Cheats 구매', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
	...
	hi: {
		...
		legal: () => 'सहायता: support@deadsidecheats.com',
	},
	id: {
		buy: 'Beli Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
		...
		legal: () => 'support@deadsidecheats.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Deadside Cheats', undetected: 'undetected', maps: 'maps, compounds, and loot zones',
