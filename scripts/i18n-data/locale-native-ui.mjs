...
const HOME_ABOUT = {
	de: {
		aboutTitle: 'Deadside Cheats für Windows PC',
		aboutP1Before: 'Deadside Cheats ist ein undetected Paket für Raids, Loot-Routen und Compound-PvP auf Windows PC. Eine Lizenz umfasst ESP Wallhack, Soft Aim und 2D-Radar mit BattlEye-Rebuilds nach Patches. Vergleiche Monats- und Lifetime-Pläne im',
		aboutStore: 'Preise',
		aboutP1Mid: ', und bestätige dann den Live-Status auf',
		aboutStatus: 'Live-Status',
		aboutP1After: ', bevor du kaufst.',
		aboutStore: 'Store',
		aboutP1Mid: ', dann',
		aboutStatus: 'Status',
	...
	zh: {
		aboutTitle: '適用於 Windows 的 Deadside 外掛',
		aboutP1Before: 'Deadside Cheats 是適用於 Windows PC 版 Deadside 突襲、搜刮路線與據點 PvP 的 undetected 方案。單一授權包含 ESP wallhack、Soft Aim 與 2D 雷達，並在遊戲更新後提供 BattlEye 重建。請先在',
		aboutStore: '價格方案',
		aboutP1Mid: '比較月費與終身方案，再於',
		aboutStatus: '即時狀態',
		aboutP1After: '確認方案可用後再購買。',
		aboutStore: '商店',
		aboutP1Mid: '比較方案，再查看',
		aboutStatus: '狀態',
		aboutP1After: '後再進場。',
	...
	es: {
		aboutTitle: 'Trucos Deadside para PC con Windows',
		aboutP1Before: 'Deadside Cheats es un paquete indetectable para raids, rutas de botín y PvP en compounds en PC con Windows. Una licencia incluye ESP wallhack, soft aim y radar 2D, con rebuilds de BattlEye tras cada parche. Compara planes mensuales y de por vida en',
		aboutStore: 'Precios',
		aboutP1Mid: ', luego confirma que el paquete está activo en',
		aboutStatus: 'Estado en vivo',
		aboutP1After: ' antes de comprar.',
	...
	fr: {
		aboutTitle: 'Triches Deadside pour PC Windows',
		aboutP1Before: 'Deadside Cheats est un pack indétectable pour raids, routes de loot et PvP en compounds sur PC Windows. Une licence inclut ESP wallhack, soft aim et radar 2D, avec rebuilds BattlEye après chaque patch. Comparez les forfaits mensuels et à vie sur',
		aboutStore: 'Tarifs',
		aboutP1Mid: ', puis confirmez que le pack est actif sur',
		aboutStatus: 'Statut en direct',
		aboutP1After: ' avant d\'acheter.',
	...
	pt: {
		aboutTitle: 'Cheats Deadside para PC Windows',
		aboutP1Before: 'Deadside Cheats é um pacote indetectável para raids, rotas de loot e PvP em compounds no PC Windows. Uma licença inclui ESP wallhack, soft aim e radar 2D, com rebuilds do BattlEye após patches. Compare planos mensais e vitalícios na',
		aboutStore: 'Preços',
		aboutP1Mid: ', depois confirme o status ao vivo em',
		aboutStatus: 'Status ao vivo',
		aboutP1After: ' antes de comprar.',
	...
	ru: {
		aboutTitle: 'Читы Deadside для Windows PC',
		aboutP1Before: 'Deadside Cheats — undetected пакет для рейдов, маршрутов лута и PvP на комплексах в Deadside на Windows PC. Одна лицензия включает ESP wallhack, soft aim и 2D radar с rebuilds после патчей BattlEye. Сравните месячные и lifetime-планы в',
		aboutStore: 'Цены',
		aboutP1Mid: ', затем проверьте актуальный статус на',
		aboutStatus: 'Онлайн-статус',
		aboutP1After: ' перед покупкой.',
		aboutStore: 'Магазине',
