...
const SLUGS = {
	...
	hacks: { en: 'naraka-cheats', es: 'hacks-trucos-naraka', fr: 'hacks-triche-naraka', de: 'naraka-cheats', pt: 'cheats-naraka', it: 'hacks-trucchi-naraka', nl: 'naraka-cheats', pl: 'hacks-cheatow-naraka', ru: 'naraka-cheats', tr: 'naraka-hile-hacks', ar: 'naraka-cheats', ja: 'naraka-cheats', ko: 'naraka-cheats', zh: 'naraka-cheats', hi: 'naraka-cheats', id: 'naraka-cheats', th: 'naraka-cheats', vi: 'naraka-cheats', uk: 'naraka-cheats', cs: 'naraka-cheats', ro: 'cheats-naraka', sv: 'naraka-cheats' },
};
